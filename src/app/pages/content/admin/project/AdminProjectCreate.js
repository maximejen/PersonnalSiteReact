...
import { Create, SimpleForm, TextInput, ReferenceInput, SelectInput, DateInput, ReferenceArrayInput, SelectArrayInput } from 'react-admin';

export const AdminProjectCreate = (props) => (
    <Create {...props}>
        <SimpleForm>
